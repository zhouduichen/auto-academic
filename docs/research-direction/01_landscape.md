# 01 — 研究地图 (Research Landscape)

> 状态：已完成（A/B/C/D/E/F 六簇全覆盖）| 更新日期：2026-07-30

## 总体概述

本项目围绕**"面向小数据任务的预算感知自动微调 Agent"**这一主线，横跨五个相互关联的文献簇。以下是从各簇调研中识别出的关键关系：
...
- **CCF 适配**：数据集论文可投 NeurIPS Datasets & Benchmarks 或 CCF-B 期刊
